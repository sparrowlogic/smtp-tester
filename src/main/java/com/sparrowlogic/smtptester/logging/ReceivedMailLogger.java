 ...
 *
 * <p>It logs through a dedicated logger name, {@code smtp-tester.mail.received}, which the bundled
...
public class ReceivedMailLogger {
    ...
    private static final Logger MAIL_LOG = LoggerFactory.getLogger("smtp-tester.mail.received");
