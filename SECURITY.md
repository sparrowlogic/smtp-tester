...
- `AUTH` over SMTP accepts any username and password (`smtptester.smtp.accept-any-credentials`).
...
- Message bodies are logged to stdout by default (`smtptester.logging.include-body`).
...
Report privately through **[GitHub Security Advisories](https://github.com/jackdpeterson/smtp-tester/security/advisories/new)**.
